...
const S = {
  ...
  chip: { padding: '5px 13px', borderRadius: 20, border: `1px solid ${TK.ink300}`, background: '#fff', fontSize: 11, fontWeight: 600, color: TK.ink700, cursor: 'pointer', transition: 'all 0.1s' },
  chipActive: { background: TK.ink900, color: '#fff', borderColor: TK.ink900 },
  empty: { textAlign: 'center', padding: '56px 20px', background: '#fff', borderRadius: 14, border: `1px solid ${TK.ink200}` },
  ...
  card: { background: '#fff', border: `1px solid ${TK.ink200}`, borderRadius: 10, overflow: 'hidden', transition: 'border-color 0.15s, box-shadow 0.15s' },
  ...
  badge: { fontSize: 9, fontWeight: 800, letterSpacing: '0.06em', padding: '2px 8px', borderRadius: 20, whiteSpace: 'nowrap' },
  yearEndBadge: { fontSize: 9, fontWeight: 800, background: TK.redLt, color: TK.red, padding: '2px 7px', borderRadius: 4, whiteSpace: 'nowrap', flexShrink: 0 },
  ...
  balanceTag: { display: 'flex', gap: 16, alignItems: 'center', padding: '8px 14px', borderRadius: 8, fontSize: 12, fontWeight: 600, marginTop: 8 },
  ...
  btnSecondary: { background: TK.purple, color: '#fff', border: 'none', borderRadius: 8, padding: '9px 18px', fontSize: 13, fontWeight: 600, cursor: 'pointer' },
  ...
  btnPost: { background: TK.greenLt, color: TK.green, border: 'none', borderRadius: 6, padding: '4px 10px', fontSize: 11, fontWeight: 700, cursor: 'pointer' },
  btnRev: { background: '#e0e7ff', color: '#4338ca', border: 'none', borderRadius: 6, padding: '4px 10px', fontSize: 11, fontWeight: 700, cursor: 'pointer' },
  btnDel: { background: TK.redLt, color: TK.red, border: 'none', borderRadius: 6, padding: '4px 10px', fontSize: 11, fontWeight: 700, cursor: 'pointer' },
  btnX: { background: 'none', border: 'none', fontSize: 18, cursor: 'pointer', color: TK.ink500, padding: 4, lineHeight: 1 },
  btnAddLine: { background: TK.purpleLt, color: TK.purple, border: 'none', borderRadius: 6, padding: '5px 12px', fontSize: 12, fontWeight: 600, cursor: 'pointer' },
  btnDelLine: { background: TK.redLt, color: TK.red, border: 'none', borderRadius: 6, padding: '4px 8px', fontSize: 12, cursor: 'pointer' },
  ...
  modal: { background: '#fff', borderRadius: 16, width: '100%', maxWidth: 920, maxHeight: '92vh', overflow: 'auto', boxShadow: '0 24px 64px rgba(0,0,0,0.2)' },
  ...
  input: { padding: '8px 12px', borderRadius: 8, border: `1px solid ${TK.ink300}`, fontSize: 13, color: TK.ink900, outline: 'none', width: '100%', boxSizing: 'border-box' },
  select: { padding: '8px 12px', borderRadius: 8, border: `1px solid ${TK.ink300}`, fontSize: 13, color: TK.ink900, background: '#fff', width: '100%' },
  ...
  modalErr: { margin: '0 24px 12px', padding: '10px 14px', background: TK.redLt, color: TK.red, borderRadius: 8, fontSize: 13 },
  modalFooter: { display: 'flex', gap: 10, justifyContent: 'flex-end', padding: '16px 24px', borderTop: `1px solid ${TK.ink200}` },
  confirmBox: { background: '#fff', borderRadius: 16, width: 480, padding: 28, boxShadow: '0 24px 64px rgba(0,0,0,0.2)' },
  confirmTitle: { fontSize: 17, fontWeight: 700, color: TK.ink900, marginBottom: 10 },
  confirmRef: { fontFamily: 'monospace', fontSize: 12, color: TK.ink500, background: TK.ink50, padding: '4px 10px', borderRadius: 6, display: 'inline-block', marginBottom: 8 },
