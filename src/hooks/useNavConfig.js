...
const HQ_PAGES = [
  ...
  // ── Finance ──────────────────────────────────────────────────────────────────
  { group: "Financials", icon: "◉", label: "Pricing", path: "/hq?tab=pricing" },
  { group: "Financials", icon: "🧮", label: "Costing", path: "/hq?tab=costing" },
  { group: "Financials", icon: "≡", label: "P&L", path: "/hq?tab=pl" },
  {
    group: "Financials",
    icon: "⚖️",
    label: "Balance Sheet",
  ...
  { group: "Financials", icon: "🧾", label: "Invoices", path: "/hq?tab=invoices" },
  { group: "Financials", icon: "📒", label: "Journals", path: "/hq?tab=journals" },
  { group: "Financials", icon: "🏦", label: "Bank Recon", path: "/hq?tab=bank-recon" },
  { group: "Financials", icon: "🏗️", label: "Fixed Assets", path: "/hq?tab=fixed-assets" },
  { group: "Financials", icon: "💸", label: "Expenses", path: "/hq?tab=expenses" },
  { group: "Financials", icon: "🔮", label: "Forecast", path: "/hq?tab=forecast" },
  { group: "Financials", icon: "🏛️", label: "VAT", path: "/hq?tab=vat" },
  { group: "Financials", icon: "📅", label: "Year-End Close", path: "/hq?tab=year-end-close" },
  // ── Intelligence ─────────────────────────────────────────────────────────────
  {
    group: "Analytics",
    icon: "▲",
