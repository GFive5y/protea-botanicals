  ...
  },
  {
    ...
    tabs: [
      ...
      },
      {
        id: "fin-notes",
        label: "Notes",
        desc: "IFRS disclosure notes \u00b7 accounting policies \u00b7 15 notes",
      },
      {
        id: "forecast",
        label: "Forecast",
...
function renderTab(tabId, tenantId, industryProfile, onTabChange, searchKey, searchFilter) {
  switch (tabId) {
    ...
    case "hq-recipes":     return <HQRecipeEngine />;
    case "hq-ingredients": return <HQFoodIngredients />;
    case "hq-haccp":       return <HQHaccp />;
    case "hq-food-safety": return <HQFoodSafety />;
    case "hq-cold-chain":  return <HQColdChain />;
    case "hq-recall":      return <HQRecall />;
    case "hq-nutrition":   return <HQNutritionLabel />;
    case "hq-food-intel":  return <HQFoodIntelligence />;
